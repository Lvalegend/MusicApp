...
import TrackPlayer, { Capability, State, Event, useProgress } from 'react-native-track-player';
...
const Song: React.FC<SongProps & { navigation: NavigationProp<any> }> = ({ route, navigation }) => {
    ...
    //     try {
    //         const response = await axios.get(`http://${hostNetwork}:3000/song/${id}`);
    ...
    // const getImage = async (songId: string) => {
    //     try {
    ...
    const loadTrack = async () => {
        try {
            await TrackPlayer.add({
                id: 'track1',
                url: `http://${hostNetwork}:3000/audio?id=${id}`,
                title: 'Adiyee',
        ...
        <Container colors={['black', 'black']}>
            ...
            <Content>
                ...
                <View style={styles.titleLeft}>
                    <Text style={styles.songTitle}>Hoa No Ben Duong</Text>
                    <Text style={styles.artist}>Tran Manh Quang</Text>
                </View>
                                ...
                                {dataComment.map((comment: any, index: any) => (
                                    <View key={index} style={{ padding: 10, margin: 10 }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                                            <View>
                                                <Image source={require('../../../../MusicApp/src/assets/images/avatar_trắng.jpg')} style={{ width: 40, height: 40, borderRadius: 50 }} />
                                            </View>
                                            <View>
                                                <View>
