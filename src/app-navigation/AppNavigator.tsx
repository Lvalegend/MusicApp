...
import {  PlayList, HomeScreen, Login, Register, SplashScreen, User, Downloads, UserAfterLoginOrRegister, ManageScreen, ManageCateScreen, ManageSongScreen, ManageUserScreen, ManageCountScreen, ManagePlaylistScreen, ManageInformScreen, ArtistInf, Favourite, RankingScreen, Chat, Song } from './types';
